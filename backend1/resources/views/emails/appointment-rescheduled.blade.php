<!DOCTYPE html>
<html>
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Appointment Rescheduled</title></head>
...
<tr><td style="background:linear-gradient(135deg,#2563eb,#1d4ed8);padding:24px;color:#fff;"><div style="font-size:12px;letter-spacing:.08em;text-transform:uppercase;color:#bfdbfe;font-weight:700;">ClinicSys</div><h1 style="margin:8px 0 0;font-size:22px;">Appointment Rescheduled</h1></td></tr>
<tr><td style="padding:22px;">
<p style="margin:0 0 12px;">Hi <strong>{{ $patientName ?: 'Patient' }}</strong>, your appointment was rescheduled.</p>
...
<p style="margin:12px 0 0;font-size:13px;color:#475569;">Reason: {{ $appointment->reschedule_reason ?: 'Not specified' }}</p>
</td></tr>
</table>
</td></tr></table>
</body>
